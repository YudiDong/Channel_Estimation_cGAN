...
# data path
path = "../Data_Generation/Gan_Data/Gan_10_dBIndoor2p4_64ant_32users_8pilot.mat"
...
def train(epochs):
    ...
    for epoch in range(epochs):
        ...
        matfiledata[u'predict_Gan_all_dB_Indoor2p4_64ant_32users_8pilot'] = np.array(prediction) # *** u prefix for variable name = unicode format, no issues thru Python 3.5; advise keeping u prefix indicator format based on feedback despite docs ***
        hdf5storage.write(matfiledata, '.', 'Results\Eest_cGAN_'+str(epoch + 1)+'_10db_Indoor2p4_64ant_32users_8pilot.mat', matlab_compatible=True)
